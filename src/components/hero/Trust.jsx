  ...
  return (
    <>
      <section className="process py-12 relative z-10">
        <Container>
          <Heading
            title="Trusted By 500+ Farmers."
            subtitle="Explore on the world's best & largest Bidding marketplace with our crops. We want to be a part of their smile, success and future growth."
          />
